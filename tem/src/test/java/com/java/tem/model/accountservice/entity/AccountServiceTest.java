...
class AccountServiceTest {
    ...
    void loadUserByUsernameIfNotNull() {
    	...
    	assertEquals(expected.getUsername(), accountService.loadUserByUsername(utente.getEmail()).getUsername());
    }
    ...
    void loadUserByUsernameIfNull() {
    	...
    	assertThrows(UsernameNotFoundException.class, () -> accountService.loadUserByUsername(utente.getEmail()));
    }
